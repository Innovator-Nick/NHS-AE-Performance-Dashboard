...
- DAX measure authoring (8+ custom measures)
- Power Query data transformation
- ETL pipeline development (Python + Power BI)
- Data quality validation and cleaning

Healthcare Domain
- NHS performance standards and targets
- Healthcare operational metrics (4-hour standard, DTA, breaches)
- A&E workflow and capacity challenges
- Public health data interpretation
- Stakeholder communication (clinical + operational managers)


 Learning Journey

This project was completed as part of my transition into Business Intelligence, following:

- Microsoft Power BI Data Analyst Learning Path
- DAX Fundamentals Course
- NHS Digital Ambassador training

Acknowledgments

- NHS England for publishing open, accessible healthcare data
- Power BI Community for DAX patterns and visualization best practices
- NHS Digital Ambassador Programmefor domain knowledge and healthcare context

 License

This project is licensed under the MIT License - see the [LICENSE](LICENSE) file for details.

Data License:NHS England data used under Open Government Licence v3.0
